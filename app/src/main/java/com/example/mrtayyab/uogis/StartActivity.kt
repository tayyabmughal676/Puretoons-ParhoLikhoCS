...
//                Toast.makeText(applicationContext , "you select ${myAnime}" , Toast.LENGTH_SHORT).show()
            ...
            else if (categoryList[i] == "Cartoon Series English Dubbed") {

//                Toast.makeText(applicationContext , "you select ${myAnimeMovie}" , Toast.LENGTH_SHORT).show()
                optionLinkOpen(CartoonSeriesEnglishDubbed)
            }
            else if (categoryList[i] == "Special Anime Cartoons") {

//                Toast.makeText(applicationContext , "you select ${mySpecialAnime}" , Toast.LENGTH_SHORT).show()
                optionLinkOpen(AnimeSeriesHindiSubbed)
            }

            else if (categoryList[i] == "Cartoon/Animated Movies") {

//                Toast.makeText(applicationContext , "you select ${mySuperDragon}" , Toast.LENGTH_SHORT).show()
                optionLinkOpen(CartoonAnimatedMovies)
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.about -> {
                alertAbout()
                Toast.makeText(applicationContext, "Puretoons.com" , Toast.LENGTH_LONG).show()
            }
    ...
    private val mOnNavigationItemSelectedListener = BottomNavigationView.OnNavigationItemSelectedListener { item ->
        when (item.itemId) {
            R.id.menu_home -> {
                ...
                val myHome = "https://www.puretoons.com/index.xhtml"
